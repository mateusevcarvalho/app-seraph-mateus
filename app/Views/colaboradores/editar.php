    ...
    <div class="card-body">
        ...
        <form class="row" id="form-editar">
            ...
            <div class="col-sm-12">
                ...
                <input type="text" name="comportamentais" class="form-control tags-competencia"
                       value="<?= $comportamentais ?>" required>
            </div>

            <div class="col-sm-12 mt-3">
                <label>Tecnicas: <span class="text-danger">*</span></label>
                <input type="text" name="tecnicas" class="form-control tags-competencia"
                       value="<?= $tecnicas ?>" required>
            </div>
